---
title: "baytrends Library Creation"
author: "Erik W. Leppo"
date: "`r Sys.time()`"
output: 
  html_notebook:
...
Need to remove end of line after Collate.
Need first entry on the same line as "Collate:".

```{r PKG_BUILD, eval=FALSE}
# NEWS
...
Check failures
(single vector so not very useful)
